  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="./indexAdmin.php">Espace admin </a>
      </li>

      <li class="nav-item ">
        <a class="nav-link" href="listeCategorieAdmin.php">Gérer produits </a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="clients.php">Gérer clients </a>
      </li>
      <li class="nav-item ">
